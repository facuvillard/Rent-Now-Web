  ...
  if (sent) {
    return (
      <Grid container justify="center" className={classes.imageUploader}>
        <Alert severity="info">
          <AlertTitle>¡Solicitud de Baja iniciada con éxito!</AlertTitle>
          Espera que el equipo de RentNow evalue la solicitud y efectivice la
          baja entre 24 y 48 horas.
        </Alert>
      </Grid>
    );
  }
        ...
        <>
          <Grid item xs={12}>
            <Typography className={classes.paragraph}>
              Aquí podras solicitar la baja de este complejo. Si das de baja tu
              complejo, este pasará a estado <b>Deshabilitado</b> y no se podrá
              acceder ni efectuar reservas en el mismo.
            </Typography>
            <Typography className={classes.paragraph}>
              Esta baja se concretará efectivamente entre 24 y 48 horas, y las
              reservas en curso para este complejo seran canceladas.
            </Typography>
            <Typography className={classes.paragraph}>
              En el caso de quieras volver a habilitarlo, deberas comunicarte
              con el equipo de RentNow en el apartado de <b>Contactanos</b> de
              la <a href={Routes.LANDING}>pagina principal</a> solicitando que
              tu complejo sea habilitado nuevamente.
            </Typography>
          </Grid>
          <Grid container justify="center">
            <Button
